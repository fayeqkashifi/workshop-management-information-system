...
class GeneratorTestingModel extends CI_Model
{
	function __construct()
	{
	 ...
	 function retrieveGeneratorRegisterProblem(){
        $this->db->from('generator_fragement_testing_registration_form');
	...
	function insertGeneratorRegisterProblemForm($data){
		$this->db->insert('generator_fragement_testing_registration_form',$data);
	...
	function removeGeneratorRegisterProblem($id){
		...
		return $this->db->delete('generator_fragement_testing_registration_form');
	}
	...
	function updateGeneratorRegisterProblem($id,$data){
		$this->db->where('g_f_r_id',$id);
		return $this->db->update('generator_fragement_testing_registration_form',$data);
	}
}
?>
