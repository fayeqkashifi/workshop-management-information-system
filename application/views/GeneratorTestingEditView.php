              ...
              <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>ویرایش چک لیست بعد از ترمیم</span>
                        </li>
                    </ul>
...
<div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">ویرایش چک لیست بعداز ترمیم</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <?php foreach ($data as $row) { ?>
                                        <form method="post"id="form_sample_2" data-parsley-validate action="<?=base_url()?>GeneratorTestingController/editGeneratorTesting" enctype="multipart/form-data"  class="form-horizontal">
                                        ...
                                        <label  class="control-label col-md-4">اسم جنس
                                              ...
                                              <div class=" input-icon  right">
                                                  ...
                                                  <select class="form-control" required="required "  name="g_f_r_porduct_name">
                                                    ...
                                                    <?php foreach ($productsTesting as $key) { ?>
                                                ...
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input type="radio" id="radio57" checked="checked" name="g_f_r_state" onclick="hide()" value="1" class="md-radiobtn">
