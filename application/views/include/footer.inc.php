<!-- BEGIN FOOTER -->
        <div class="page-footer" >
            <div class="page-footer-inner" style="text-align:center;float:left"> شرکت تخنیکی و انجنیری مجتبی علی|تیم دیتابیس


                <!-- <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">Purchase Metronic!</a> -->
            </div>
            <div class="scroll-to-top" style="text-align:center">
...
<![endif]-->
       ...
       <!-- END PAGE LEVEL PLUGINS -->
        ...
        <script src="<?=base_url();?>/assets/pages/scripts/portfolio-2.min.js" type="text/javascript"></script>
...
<!-- END PAGE LEVEL SCRIPTS -->
        ...
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?=base_url();?>/assets/global/plugins/bootstrap-sessiontimeout/bootstrap-session-timeout.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <!-- <script src="<?=base_url();?>/assets/pages/scripts/ui-session-timeout.js" type="text/javascript"></script> -->
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        ...
        <!-- BEGIN PAGE LEVEL PLUGINS -->
          ...
          <!-- BEGIN PAGE LEVEL SCRIPTS -->
          <!-- BEGIN PAGE LEVEL PLUGINS -->
          <script src="<?=base_url()?>/assets/global/plugins/bootstrap-confirmation/bootstrap-confirmation.js" type="text/javascript"></script>
          <!-- END PAGE LEVEL PLUGINS -->
                  ...
                  var SessionTimeout = function () {
                      ...
                      var handlesessionTimeout = function () {
                          $.sessionTimeout({
                              ...
                              message: 'شما بیشتر از پنج دقیفه در سیستم کار نکرده اید.',
                              keepAliveUrl: '../demo/timeout-keep-alive.php',
                              redirUrl: '<?=base_url();?>logoutController',
